...
export default function Fabric() {
  return (
    ...
    <h4>Advanced Basalt Fiber Fabrics have specific proprieties and can be moulded with other fabrics to get the exact result you need in the process applications below:</h4>
      <ol>
        <li>Pultrusion;</li>
        <li>Prepregs;</li>
        <li>SMC and BMC;</li>
